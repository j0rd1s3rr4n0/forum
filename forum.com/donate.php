...
<html lang="es" >
  <head>
    <meta charset="UTF-8">
    <title>BLUEGRADED - Donate 🪙 </title>
    <style>
    @import url('https://fonts.googleapis.com/css2?family=Roboto&display=swap');
    :root {
    --main-color: #263038  !important;
    --second-color: #f4eb72;
    font-family: Arial;
    }
    body{
    ...
    outline: 1px dashed var(--second-color);
    outline-offset:10px;
    padding:10px;
    }
    select{
    ...
    select:hover{
      border: 0px dashed var(--second-color);
      border-radius:20px;
      outline: 1px dashed var(--second-color);
    outline-offset:10px;
    }
    ...
    option:link{color:orange;}
    option:visited{color:black;}
    option:focus{color:yellow;}
    option:hover{color:red}
    option:active{color:green;}
    </style>
  ...
  <body translate="no" >
    <body>
      <div class="container-fluid">
        <input type="image" src="assets/img/welcome.gif" onerror="this.src='https://cdn.discordapp.com/attachments/496822039785635840/504737841947869194/Welcome_gif_yellow.gif';console.error('ERROR - IMAGEN WELCOME');" class="welcome" alt="Welcome!" width="30%"></br>
        <center>
        <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
          <input type="hidden" name="cmd" value="_s-xclick">
          <input type="hidden" name="hosted_button_id" value="WM257SQKJRP9J">
            <h1 class="subs-text">Suscripción para el apoyo a la web y al desarrollador</h1></td></tr><tr><td class="alineado-centro">
          <!--<table>
            <tr><td ><input type="hidden" name="on0" value="Opciones de pago">
          <select name="os0">
            <option value="1 mes">1 mes : €1,00 EUR - mensualmente</option>
            <option value="3 meses">3 meses : €2,50 EUR - mensualmente</option>
            <option value="6 meses">6 meses : €1,00 EUR - mensualmente</option>
            <option value="12 meses">12 meses : €8,00 EUR - anualmente</option>
          </select> </td></tr>
        </table>-->
        <input type="hidden" name="currency_code" value="EUR">
        <input type="image" class="donate-button" src="assets/img/donate.gif" onerror="this.src='https://cdn.dribbble.com/users/293579/screenshots/2654307/donate_dribbble.gif';console.error('ERROR - IMAGEN DONATE');" border="0" name="submit" alt="PayPal, la formaf rápida y segura de pagar en Internet." width="15%">
        <img alt="" border="0" src="https://www.paypalobjects.com/es_ES/i/scr/pixel.gif" width="1" height="1">
      </form>
      </center>
    </div>
    <script type="text/javascript">
    document.querySelector("#root > div > div > div > div > div > div.css-faeyfb > div.MuiGrid-root.css-1jhw711.MuiGrid-container.MuiGrid-align-items-xs-flex-end.MuiGrid-justify-content-xs-center > a").innerHTML = "<h1>helloworld</h1>";
    </script>
    <!-- Smartsupp Live Chat script -->
    <!--
    <script type="text/javascript">
    var _smartsupp = _smartsupp || {};
    _smartsupp.key = '991a8670d3512a47afe564f7d20d68409a9fe0d5';
    ...
    <script src=“//platform-api.sharethis.com/js/sharethis.js#property=&product=sticky-share-buttons”></script>-->
    
    
    <script id="rendered-js" >
    // LIVE CHAT SCRIPT
 var _smartsupp = _smartsupp || {};
 _smartsupp.key = '1408f323c06ea7a36a11736ffb9ebbab460bc3e4';
 window.smartsupp || (function(d) {
 ...
 (function() {
     window.__sharethis__.md5 = "2f960effe732ea44ec16a5711ff36bc6";
 })();
  </script>
